...
<div class="container">
    ...
    <div class="carousel-inner">
      <div class="carousel-item">
        <div class="card flex-md-row mb-4 box-shadow h-md-250">
          ...
          <div class="card-body d-flex flex-column align-items-start">
            <h3 class="mb-3">
              <a class="text-dark" href="#">Title 1</a>
            </h3>
            <div class="mb-2">36.25 €</div>
            <p class="card-text mb-auto w-100 h-100" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Il testo (dal latino textus, "tessuto", "tram</div>
        </div>
      </div>
      <div class="carousel-item active">
        <div class="card flex-md-row mb-4 box-shadow h-md-250">
          ...
          <div class="card-body d-flex flex-column align-items-start">
            <h3 class="mb-3">
              <a class="text-dark" href="#">Title 2</a>
            </h3>
            <div class="mb-2">36.25 €</div>
            <p class="card-text mb-auto w-100 h-100" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Il testo (dal latino textus, "tessuto", "tram</div>
        </div>
  ...
  <div class="alert alert-danger">
    ...
    <input type="submit" class="btn btn-info" value="Submit Button"><!--bottone login-->
